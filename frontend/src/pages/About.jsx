  ...
  return (
    <>
      ...
      <div className='flex flex-col md:flex-row '>
        ...
        <div className="">
          <img
            className="w-full max-w-5xl md:max-w-6xl lg:max-w-7xl border border-gray-200 rounded-xl shadow-lg bg-white"
        ...
        {/* right side */}
        <div className='text-gray-500 px-15 py-15 md:py-0  text-justify'>
      ...
      <h1 className='text-2xl font-semibold py-15'>Why Choose Us: </h1>
