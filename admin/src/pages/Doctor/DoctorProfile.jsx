...
const DoctorProfile = () => {
  ...
  return (
    ...
    <div className="w-full max-w-6xl m-5 overflow-y-auto">
      ...
      <div className="max-w-lg flex flex-col gap-2 text-sm bg-gray-200 w-full rounded-lg px-8 py-4 shadow-lg">
        <img className="w-36 rounded  " src={doctorData.image} alt="" />
        {isEdit ? (
          <input
        ...
        <div>
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
            ...
            {isEdit ? (
              ...
              <p className="text-blue-400">{doctorData.speciality}</p>
            )}
            ...
            {isEdit ? (
              ...
              <p className="text-blue-400">{doctorData.fees}</p>
            )}
            ...
            {isEdit ? (
              <p
                className="w-full bg-gray-100 text-gray-600 border rounded-md p-2 min-h-20 outline-none"
              ...
              <p className="text-gray-600 border min-h-20 rounded-md p-1">
                {doctorData.about}
              </p>
            )}
          </div>
